...
export function AdminLayoutClient({
  ...
  const brandName = settings ? (locale === "th" ? settings.nameTh : settings.nameEn) : t("app.name");
  const brandTagline = settings ? (locale === "th" ? settings.nameEn : settings.nameTh) : t("app.tagline");
